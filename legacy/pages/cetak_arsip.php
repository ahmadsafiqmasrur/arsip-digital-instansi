...
<style>
    ...
    .search-input-large:focus {
        border-color: #ffb822; /* Use yellow for print actions */
    }
    .btn-search-large {
...
<div class="cetak-container">
    ...
    <div class="search-box">
        ...
        <form action="index.php" method="GET" class="search-form-centered">
            <input type="hidden" name="page" value="cetak_arsip">
            <input type="text" name="search_cetak" class="search-input-large" placeholder="Masukkan kata kunci..." value="<?= htmlspecialchars($search) ?>" required>
        ...
        <table class="cetak-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="pdf/cetak.php?id=<?= $row['id'] ?>" class="btn-action-cetak" target="_blank">
